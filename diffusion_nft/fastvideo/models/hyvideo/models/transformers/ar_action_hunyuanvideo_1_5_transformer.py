...
class MMDoubleStreamBlock(nn.Module):
    ...
    def forward_vision(
        ...
        # Add continuous camera pose via PRoPE
...
class ARHunyuanVideo_1_5_DiffusionTransformer(ModelMixin, ConfigMixin):
    ...
    def add_discrete_action_parameters(self):
        ...
        # PRoPE parameters, zero-initialized
        for block in self.double_blocks:
    ...
    def forward_txt(
        ...
        vec_txt = self.time_in(timestep_txt)  # computed separately for the text prompt
    ...
    def forward_vision(
        ...
        vec = vec + self.action_in(action)  # add the discrete action
