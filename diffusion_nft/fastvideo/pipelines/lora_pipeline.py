...
class LoRAPipeline(ComposedPipelineBase):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if self.training_mode and getattr(
            ...
            if self.lora_target_modules is None:
                self.lora_target_modules = [
                    ...
                    "to_out",
                    "to_qkv",
                    # HunyuanVideo attention layer names
                    "img_attn_q",
                    "img_attn_k",
                    "img_attn_v",
                    "img_attn_proj",
                    ...
                    "img_attn_prope_proj",  # PRoPE camera projection
                    "action_in",            # action embedding (TimestepEmbedder)
                ]
    ...
    def set_lora_adapter(self, lora_nickname: str, lora_path: str | None = None):  # type: ignore
        ...
        if lora_path is not None and lora_path != self.cur_adapter_path:
            ...
            to_merge_params: defaultdict[Hashable, dict[Any, Any]] = (
                defaultdict(dict)
            )
