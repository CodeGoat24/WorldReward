...
from fastvideo.layers.attention.selector import backend_name_to_enum, get_attn_backend
...
from fastvideo.utils.forward_context import ForwardContext, get_forward_context
...
class DistributedAttention_VSA(DistributedAttention):
    ...
    def forward(
        ...
        assert (
            replicated_q is None
            and replicated_k is None
