...
class PipelineConfig:
    ...
    def update_config_from_dict(
        self, args: dict[str, Any], prefix: str = ""
    ) -> None:
        prefix_with_dot = f"{prefix}." if (prefix.strip() != "") else ""
    ...
    def from_kwargs(
        ...
        pipeline_config_or_path: (
            str | PipelineConfig | dict[str, Any] | None
        ) = kwargs.get(prefix_with_dot + "pipeline_config", None) or kwargs.get(
            "pipeline_config"
        )
        ...
        if isinstance(pipeline_config_or_path, str):
            ...
            kwargs[prefix_with_dot + "pipeline_config_path"] = (
                pipeline_config_or_path
            )
